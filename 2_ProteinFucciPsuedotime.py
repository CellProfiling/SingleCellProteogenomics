...
from SingleCellProteogenomics import ProteinFucciPseudotime, ProteinVariability, ProteinBimodality, CellCycleDependence
...
pseudotime_result = ProteinFucciPseudotime.fucci_polar_coordinate_calculations(fucci_data, 
