...
plate = np.load("output/plate.filterNegStain.npy")
u_plate = np.load("output/u_plate.filterNegStain.npy")
well_plate=np.load("output/well_plate.filterNegStain.npy")
imgnb=np.load("output/imgnb.filterNegStain.npy")
u_well_plates=np.load("output/u_well_plates.filterNegStain.npy")
ab_objnum=np.load("output/ab_objnum.filterNegStain.npy")
ab_nuc=np.load("output/ab_nuc.filterNegStain.npy")
ab_cyto=np.load("output/ab_cyto.filterNegStain.npy")
ab_cell=np.load("output/ab_cell.filterNegStain.npy")
mt_cell=np.load("output/mt_cell.filterNegStain.npy")
green_fucci=np.load("output/green_fucci.filterNegStain.npy")
red_fucci=np.load("output/red_fucci.filterNegStain.npy")
log_red_fucci_zeroc=log_green_fucci_zeroc=np.load("output/log_green_fucci_zeroc.filterNegStain.npy")
log_red_fucci_zeroc=np.load("output/log_red_fucci_zeroc.filterNegStain.npy")
log_green_fucci_zeroc_rescale=np.load("output/log_green_fucci_zeroc_rescale.filterNegStain.npy")
log_red_fucci_zeroc_rescale=np.load("output/log_red_fucci_zeroc_rescale.filterNegStain.npy")
fucci_data = np.load("output/fucci_data.filterNegStain.npy")
wp_cell_kruskal_adj = np.load("output/wp_cell_kruskal_adj.filterNegStain.npy")
wp_nuc_kruskal_adj = np.load("output/wp_nuc_kruskal_adj.filterNegStain.npy")
wp_cyto_kruskal_adj = np.load("output/wp_cyto_kruskal_adj.filterNegStain.npy")
wp_pass_bh_cell = np.load("output/wp_pass_bh_cell.filterNegStain.npy")
wp_pass_bh_nuc = np.load("output/wp_pass_bh_nuc.filterNegStain.npy")
wp_pass_bh_cyto = np.load("output/wp_pass_bh_cyto.filterNegStain.npy")
print("loaded")
