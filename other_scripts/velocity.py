...
adata = sc.read_csv("input/Tpms.csv.protein_coding.csv")
adata.obs_names = pd.read_csv("input/Tpms.obs_names.csv")["well_plate"]
...
adata.obs["fucci_time"] = np.array(pd.read_csv("input/fucci_time.csv")["fucci_time"])
...
ldata = scv.read("output/velocyto/a.loom")
ldata.obs_names = pd.read_csv("output/velocyto/a.obs_names.csv")["well_plate"]
...
mean_diff_from_rng = np.load("input/mean_diff_from_rng.npy", allow_pickle=True)
